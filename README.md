...
### &#127875; Интересные проекты:
- [Автоматизация проведения митапов](https://github.com/jull04/meetup-angular) 
- [Кото-пинетрест](https://github.com/jull04/cat-pinterest) <img src="https://img.shields.io/badge/Angular-red?logo=angular&logoColor=white" alt="Angular" title="Angular"/> <img src="https://img.shields.io/badge/TypeScript-blue?logo=typescript&logoColor=white" alt="TypeScript" title="TypeScript"/>
